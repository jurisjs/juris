...
class ComponentManager {
    ...
    #createLifecycleComponent(result, name, props, compStates) {
        ...
        const element = this.juris.domRenderer.render({
            div: {
                'data-juris-component': name,
                style:{display:'contents'},
                children: reactiveRender()
            }
        }, false, name);
        if (element) {
...
class DOMRenderer {
    ...
    _setStaticAttribute(element, attr, value) {
        ...
        // Lean boolean check - check if property exists and is boolean type
